...
#include "VUXN1230_tb.h"
#include "VUXN1230_tb_UXN1230_tb.h"
#include "VUXN1230_tb_fx2.h"
...
static PyObject *init(PyObject *self, PyObject *args) {
  ...
  tb   = new VUXN1230_tb("tb");	// Create instance of module
  Verilated::debug(0);
...
#endif
PyMODINIT_FUNC initVUXN1230_tb(void) {
    PyObject* m;

    import_nitro();
    m = Py_InitModule3("VUXN1230_tb", Vtb_methods,
